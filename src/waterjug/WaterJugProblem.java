...
public class WaterJugProblem extends Problem {
    ...
    public WaterJugProblem() {
        reset();
        setFinalState(new WaterJugState(2, 2));
        setIntroduction("Welcome to the Water Jug Problem\n\n" +
                        ...
                        "or pout all or some of either jug into the other. The goal is to\n" +
    ...
    public List<Move> getMoves()
    {
        ...
        movesTemp.add(new WaterJugMove("Fill Jug X"));
        movesTemp.add(new WaterJugMove("Fill Jug Y"));
        movesTemp.add(new WaterJugMove("Empty Jug X"));
        movesTemp.add(new WaterJugMove("Empty Jug Y"));
        movesTemp.add(new WaterJugMove("Transfer Jug X to Jug Y"));
        movesTemp.add(new WaterJugMove("Transfer Jug Y to Jug X"));
        return movesTemp;
    }
	...
	WaterJugState cur = (WaterJugState)getCurrentState();
        return (cur.getXGallons() == 2 || cur.getYGallons() == 2);
    }
    ...
    public boolean searchSuccess(State s)
    {
        ...
        return (state.getXGallons() == 2 || state.getYGallons() == 2);
    }
